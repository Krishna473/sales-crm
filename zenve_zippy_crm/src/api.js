...
export const TABLE_CONFIG = {
  ...
  // NOTE: the backend has no /regional-managers or /sales-managers routes
  // yet — these use the same shape as sales_executives (the closest
  // existing table) as a placeholder schema. Opening either section will
  // show the usual "couldn't reach backend" banner until those routes
  // exist. Once they do, only the field list here (if the real schema
  // differs) would need updating.
  regional_managers: {
