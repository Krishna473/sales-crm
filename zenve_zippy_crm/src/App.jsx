...
import SalesPortal from "./components/sales/SalesPortal.jsx";
...
export default function App() {
  ...
  if (showSalesCRM) {
    return <SalesPortal onExitToAdmin={() => setShowSalesCRM(false)} />;
  }
        ...
        {activeTab === "data" && (
          <>
            <StatsGrid
              ...
              stats={findGroupLabel(currentKey) === "Sales team" ? SALES_TEAM_STATS : undefined}
            />
